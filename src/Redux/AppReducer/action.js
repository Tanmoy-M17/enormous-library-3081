...
import {
  GET_ATYPE_PRODUCTS_FAILURE,
  GET_ATYPE_PRODUCTS_REQUEST,
  GET_ATYPE_PRODUCTS_SUCCESS,
  GET_PRODUCTS_FAILURE,
  GET_PRODUCTS_REQUEST,
  GET_PRODUCTS_SUCCESS,
  GET_SINGEL_PRODUCTS_FAILURE,
  GET_SINGEL_PRODUCTS_REQUEST,
  GET_SINGEL_PRODUCTS_SUCCESS,
} from "./actionType";
import {
  POSTDATA_SUCCESS,
  POSTDATA_REQUEST,
...
export const getAtypeproduct =
  ...
  (dispatch) => {
    ...
    axios
      ...
      .then((r) =>
        dispatch({ type: GET_ATYPE_PRODUCTS_SUCCESS, payload: r.data })
      )
...
export const getSingelProduct =
  ...
  (dispatch) => {
    ...
    axios
      ...
      .then((r) =>
        dispatch({ type: GET_SINGEL_PRODUCTS_SUCCESS, payload: r.data })
      )
...
export const postData = (payload) => (dispatch) => {
  ...
  return axios
    .post("http://localhost:8080/cars", payload)
    .then((r) => {
      dispatch({ type: POSTDATA_SUCCESS, payload: r.data });
