...
function FiltScooter() {
  ...
  return (
    ...
    >
      <div style={{ fontSize: "23px", fontWeight: "bold" }}>Used Scooters</div>
      <div>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ flexGrow: "1" }}></div>
        {!budgetFlag ? (
          <DownOutlined onClick={() => setBudgetFlag(!budgetFlag)} />
        ) : (
          <UpOutlined onClick={() => setBudgetFlag(!budgetFlag)} />
        )}
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ flexGrow: "1" }}></div>
        {!KMFlag ? (
          <DownOutlined onClick={() => setKMFlag(!KMFlag)} />
        ) : (
          <UpOutlined onClick={() => setKMFlag(!KMFlag)} />
        )}
      </div>
      ...
      <div style={{ display: "flex", alignItems: "center" }}>
        ...
        <div style={{ flexGrow: "1" }}></div>
        {!yearFlag ? (
          <DownOutlined onClick={() => setYearFlag(!yearFlag)} />
        ) : (
          <UpOutlined onClick={() => setYearFlag(!yearFlag)} />
        )}
      </div>
