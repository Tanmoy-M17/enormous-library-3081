...
import { CategoryNavbar } from "./Cssstyles";
    ...
    <CategoryNavbar>
      <div>
        <select style={{ border: "none", outline: "none" }}>
          ...
          <option value="">For Sale: Houses & Apartments</option>
          <option value="">Scooter</option>
          <option value="">Commercial & Other Vehicles</option>
      ...
      <nav className="navbar navbar-expand-md navbar_custom sec-nav">
            ...
            <ul className="navbar-nav">
              <li className="nav-item dropdown p-2">
                ...
                >
                  ...
                  <span
                    ref={toggleRef}
                    className={`mx-1 fa fa-chevron-down`}
                  ></span>
                </Link>
                  ...
                  <div className="container-fluid">
                    <div className="row navbar-dropdown-child">
                      <div className="col-md-3 col-sm-6 col-xsm-6">
                        <Link
                          className="dropdown-item nav-link-text font-weight-bold"
                          to="/"
                        >
                          Vehicles
                        </Link>
                        <Link className="dropdown-item nav-link-text" to="/">
                          Tractors &amp; Trailers
                        </Link>
                        <Link className="dropdown-item nav-link-text" to="/">
                          Boats
        ...
        <Link to="/houseForSale">For Sale: Houses & Apartments</Link>
        <Link to="/scooters">Scooters</Link>
        <Link to="/CommericalVPage">Commercial & Other Vehicles</Link>
        <Link to="/houseForRent">For Rent: Houses & Apartments</Link>
      </div>
    </CategoryNavbar>
  );
};
