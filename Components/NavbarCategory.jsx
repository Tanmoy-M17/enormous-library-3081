...
{/* 
      ...
      <Link to="/houseForSale">SaleHousesAndApartments</Link>
      <Link to="/scooters">Scooters</Link>
      <Link to="/CommericalVPage">ComercialAndOtherVehicles</Link>
      <Link to="/houseForRent">RentHousesAndApartments</Link>
      </div>
    </CategoryNavbar>
  );
};
